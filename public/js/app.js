...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchArticles: function fetchArticles(page_url) {
      ...
      fetch(new_page_url).then(function (response) {
        return response.json();
      }).then(function (response) {
        _this.articles = response.data;
        var pageDetails = Object.assign({}, response);
    ...
    makePagination: function makePagination(pageDetails) {
      var pagination = {
    ...
    clearForm: function clearForm(article) {
      this.edit = false;
      this.article = {};
    }
  }
  ...
  return _c(
    ...
    [
          ...
          _c(
            ...
            [
              _c("input", {
                ...
                staticStyle: { padding: "5px", width: "calc(100% - 10px)" },
              ...
              _c("input", {
                attrs: { type: "submit" },
                domProps: { value: [!_vm.edit ? "Save" : "Update"] }
              }),
              _vm._v(" "),
              _c("input", {
                attrs: {
                  type: "button",
                  value: [!_vm.edit ? "Clear" : "Cancel"]
                },
                on: {
                  click: function($event) {
                    return _vm.clearForm(_vm.article)
                  }
                }
              })
            ]
      ...
      _c(
        ...
        [
          _c("li", { staticStyle: { display: "table-cell" } }, [
            _c(
              "a",
              {
                style: [
                  !_vm.pagination.prev_page ? { "pointer-events": "none" } : {}
                ],
                attrs: { href: "javascript:void(0);" },
                on: {
                  click: function($event) {
                    return _vm.fetchArticles(_vm.pagination.prev_page)
                  }
                }
              },
              [_vm._v("Prev")]
          ...
          _c(
            "li",
            { staticStyle: { padding: "0 10px", display: "table-cell" } },
            [
              _vm._v(
                "\n            Page " +
          ...
          _c("li", { staticStyle: { display: "table-cell" } }, [
            _c(
              ...
              {
                style: [
                  !_vm.pagination.next_page ? { "pointer-events": "none" } : {}
                ],
                attrs: { href: "javascript:void(0);" },
                on: {
                  click: function($event) {
                    return _vm.fetchArticles(_vm.pagination.next_page)
                  }
                }
              },
              [_vm._v("Next")]
      ...
      _vm._l(_vm.articles, function(article) {
        return _c(
          "div",
          {
            ...
            attrs: { title: article.created_at }
          },
          [
